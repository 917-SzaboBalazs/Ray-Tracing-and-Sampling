...
public class RawCtMask: Geometry
{
    ...
    public RawCtMask(string datFile, string rawFile, Vector position, double scale, ColorMap colorMap) : base(Color.NONE)
    {
        ...
        /*Console.WriteLine(vectorToString(_v0));
        Console.WriteLine(vectorToString(_v1));
        */
    ...
    public override Intersection GetIntersection(Line line, double minDist, double maxDist)
    {
        ...
        */
        ...
        {
            Color currColor = GetColor(line.CoordinateToPosition(t));
            modifier *= 1 - currColor.Alpha;

            if (currColor.Alpha == 1) break;

            color += new Color(modifier * currColor.Red, modifier * currColor.Green, modifier * currColor.Blue, modifier * currColor.Alpha);
        }*/
